        ...
        return (
            <View>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                    <Text style={{ ...Fonts.JostSemiBoldBlack }}>Name :</Text>
                    <Text style={{ ...Fonts.JostMediumBlack }}>{addressSelect?.name}</Text>
                </View>
                <View style={{flexDirection:'row',alignItems:'center',gap:6}}>
                    <Text style={{ ...Fonts.JostSemiBoldBlack }}>Address:</Text>
                    <Text style={{...Fonts.JostMediumBlack,flex:1,flexWrap:'wrap'}}>
                {addressSelect?.house},{addressSelect?.area},{addressSelect?.city},{addressSelect?.state},{addressSelect?.pincode}
                    </Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                    <Text style={{ ...Fonts.JostSemiBoldBlack }}>Phone Number :</Text>
                    <Text style={{ ...Fonts.JostMediumBlack }}>{addressSelect?.phone}</Text>
                </View>
