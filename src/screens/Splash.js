import { View, Text, Dimensions, Image, ImageBackground, Alert, BackHandler, TouchableOpacity } from 'react-native';
...
const Splash = ({ props, route, data, navigation, data1, dispatch }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.white, justifyContent: 'center', alignItems: 'center' }}>
      ...
      />
      <ImageBackground
        source={require('../assets/images/HelloKundliSplash.png')}
        style={{
          width: width,
        ...
        <View style={{ marginTop: SCREEN_WIDTH * 0.2 }}>
          <Text style={{ ...Fonts.JostSemiBoldBlack, fontSize: 26 }}>Discover Your Cosmic Journey</Text>
          {/* <TouchableOpacity style={{ height: 60, width: 60, borderRadius: 30, backgroundColor: '#FFFFA7', alignItems: 'center', justifyContent: 'center', alignSelf: 'center', top: SCREEN_WIDTH * 0.4 }}>
            <Image source={require('../assets/images/RightIcon.png')} resizeMode='contain' style={{ height: 40, width: 40 }} />
          </TouchableOpacity> */}
