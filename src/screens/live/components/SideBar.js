    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <SvgXml
          ...
          <path d="M0 18.2444C0 15.3271 1.13718 12.5007 3.2955 10.5379C18.9187 -3.67045 30.5112 -3.34373 46.4974 10.5071C48.7802 12.485 50 15.399 50 18.4195V72.6881C50 76.0018 47.3137 78.6881 44 78.6881H6C2.68629 78.6881 0 76.0018 0 72.6881V18.2444Z" fill="#FFA200"/>
          </svg>`}
        />
