...
const AstrologerDetailes = ({
  ...
  console.log(customerData?.free_call, 'IMage ')
      ...
      <View style={{ flexDirection: 'row', marginHorizontal: Sizes.fixPadding }}>
        ...
        >
          ...
          <View style={{ marginVertical: Sizes.fixPadding }}>
            <Text style={styles.servicesCol2}>{showNumber(customerData?.free_call == 1 ? astroData?.call_price + parseFloat(astroData?.commission_call_price) : 0)}/min</Text>
            <Text style={styles.servicesCol3}>{showNumber(customerData?.free_call == 1 ? callmultiply2 : 0)} /min</Text>
          </View>
        </LinearGradient>
        <LinearGradient
          // colors={['#F87956', '#FF452C']}
        ...
        >
          ...
          <View style={{ marginVertical: Sizes.fixPadding }}>
            <Text style={styles.servicesCol2}>{showNumber(customerData?.free_chat == 1 ? astroData?.chat_price + parseFloat(astroData?.commission_chat_price) : 0)}/min</Text>

            <Text style={styles.servicesCol3}>{showNumber(customerData?.free_chat == 1 ? chatmultiply2 : 0)} /min</Text>
          </View>
        </LinearGradient>
        <LinearGradient
          // colors={['#F87956', '#FF452C']}
    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          style={{
            paddingVertical: Sizes.fixPadding,
            backgroundColor: getChatColor(astroData?.video_call_status),
            width: '40%',
            borderRadius: 1000,
            marginBottom: 10, alignSelf: 'center'
          }}>
          <Text style={{ textAlign: 'center', ...Fonts.white14RobotoMedium }}>
            Video Call
          </Text>
        </TouchableOpacity>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <TouchableOpacity
            ...
            style={{
              paddingVertical: Sizes.fixPadding,
              backgroundColor: getChatColor(astroData?.chat_status),
              width: '40%',
              borderRadius: 1000,
            }}>
            <Text style={{ textAlign: 'center', ...Fonts.white14RobotoMedium }}>
          ...
          <TouchableOpacity
            ...
            style={{
              paddingVertical: Sizes.fixPadding,
              backgroundColor: getChatColor(astroData?.call_status),
              width: '40%',
              borderRadius: 1000,
            }}>
            <Text style={{ textAlign: 'center', ...Fonts.white14RobotoMedium }}>
