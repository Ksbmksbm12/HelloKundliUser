...
import { SVGMapIcons, SVGUserIcons } from '../../assets/svg';
...
const NewMatching = ({ customerData, navigation, route, dispatch, locationData, subLocationData }) => {
  ...
  const get_matching = async (mid, fid) => {
    if (validation()) {
      ...
      console.log("dataofMatching:::", matchingPayload)
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.black_color1 }}>
      ...
      <MyStatusBar />
      <MyHeader title={'Match Matching'} navigation={navigation} />
      <ScrollView showsVerticalScrollIndicator={false}>
        <View
          ...
          <View style={styles.containerBox}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{ ...styles.inputContainer, flex: 0.47, padding: 15 }}>
            ...
            <TouchableOpacity
              ...
              style={{ ...styles.inputContainer, marginBottom: 5, padding: 15 }}>
              {/* <MaterialCommunityIcons
                name="map-marker"
                color={colors.black_color8}
                size={25}
         ...
         >
          ...
          <View style={styles.containerBox}>
            <View style={[styles.inputContainer, { padding: 4 }]}>
              <SVGUserIcons />
              <KeyboardAvoidingView
