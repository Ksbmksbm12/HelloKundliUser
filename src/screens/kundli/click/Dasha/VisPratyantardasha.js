...
const VisPratyantardasha = ({ dispatch, vismahadas }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Vinshottari Mahadasha</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(VisPratyantardasha);
