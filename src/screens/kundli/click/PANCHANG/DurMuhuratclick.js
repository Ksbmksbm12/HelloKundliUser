...
const DurMuhuratclick = ({ navigation, locationData, dispatch, isLoading, props }) => {
  ...
  const dropdownData = [
    { label: 'Gulikkaal', value: 'gulikkaal' },
    { label: 'Rahukaal', value: 'rahukaal' },
    { label: 'Varjyam', value: 'varjyam' },
    { label: 'Yamgantakkaal', value: 'yamgantakkaal' },
  ...
  const handleFetchKundli = () => {
    if (!selectedOption) {
      warnign_toast('Please select Duruhurat For');
      return false;
    }
      ...
      dispatch(KundliActions.getDurmuhurat(payload));
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={handleFetchKundli}>
          <Text style={{ ...Fonts.JostSemiBoldGray, color: 'white', fontSize: 20 }}>Show Yog</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default connect(mapStateToProps, mapDispatchToProps)(DurMuhuratclick);
