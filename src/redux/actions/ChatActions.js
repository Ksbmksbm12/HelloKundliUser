...
export const getonAudioCallEnd = payload => ({
    type: actionTypes.GET_ON_AUDIO_CALL_END,
    payload
})
export const setonAudioCallEnd = payload => ({
    type: actionTypes.SET_ON_AUDIO_CALL_END,
    payload
})
...
export const setGenerateidData = payload => ({
    type: actionTypes.SET_GENERATEID_DATA,
    payload
})

export const setCameraChatVision = payload => ({
    type: actionTypes.SET_CAMERA_CHAT_VISION,
    payload
});

export const setCameraChatHand = payload => ({
    type: actionTypes.SET_CAMERA_CHAT_HAND,
    payload
})
