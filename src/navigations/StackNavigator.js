...
import Laganchart from '../screens/kundli/click/Laganchart';
import MoonChartScreen from '../screens/kundli/click/MoonChart';
import PlanetryStatus from '../screens/kundli/click/PlanetryStatus';
import AvakhadaChakra from '../screens/kundli/click/AvakhadaChakra';
import GhatChakra from '../screens/kundli/click/GhatChakra';
import SarvastakData from '../screens/kundli/click/SarvastakData';
import Kalsarp from '../screens/kundli/click/Kalsarp';
import Maglik from '../screens/kundli/click/Maglik';
import Sadesati from '../screens/kundli/click/Sadesati';
import RemediesData from './RemediesData';
import VismotriDasha from './VismotriDasha';
import DevisionChart from '../screens/kundli/click/DevisionChart';
import Atakvarrga from './Atakvarrga';
import Astkoota from '../screens/kundli/click/Match/Astkoota';
import Astkootdosha from '../screens/kundli/click/Match/Astkootdosha';
import MangliMatch from '../screens/kundli/click/Match/MangliMatch';
import MatchConculsion from '../screens/kundli/click/Match/MatchConculsion';
import Panchangeclick from '../screens/kundli/click/PANCHANG/Panchangeclick';
import PanchangeData from '../screens/kundli/click/PANCHANG/PanchangeData';
import PanchHome from '../screens/kundli/click/PANCHANG/PanchHome';
import Muhurat from '../screens/kundli/click/PANCHANG/Muhurat';
import DurMuhurat from '../screens/kundli/click/PANCHANG/DurMuhurat';
import Yogdata from '../screens/kundli/click/PANCHANG/Yogdata';
import Yoghome from '../screens/kundli/click/PANCHANG/Yoghome';
import Pnachang from './Pnachang';
import AddAddress from '../screens/ecommerce/AddAddress';
import Address from '../screens/ecommerce/Address';
import Supportuser from '../screens/blogs/Supportuser';
...
const StackNavigator = (data, data1) => {
  ...
  return (
    ...
    <Stack.Navigator initialRouteName={data?.data1?.redirect_app} >
      ...
      <Stack.Screen name='laganchart' component={Laganchart} options={{ headerShown: false }} />
      <Stack.Screen name='moonChart' component={MoonChartScreen} options={{ headerShown: false }} />
      <Stack.Screen name='planetstatus' component={PlanetryStatus} options={{ headerShown: false }} />
      <Stack.Screen name='avakhadachakra' component={AvakhadaChakra} options={{ headerShown: false }} />
      <Stack.Screen name='ghatchkara' component={GhatChakra} options={{ headerShown: false }} />
      <Stack.Screen name='sravadata' component={SarvastakData} options={{ headerShown: false }} />
      <Stack.Screen name='kalsarp' component={Kalsarp} options={{ headerShown: false }} />
      <Stack.Screen name='manglik' component={Maglik} options={{ headerShown: false }} />
      <Stack.Screen name='sadesati' component={Sadesati} options={{ headerShown: false }} />
      <Stack.Screen name='remediesdata' component={RemediesData} options={{ headerShown: false }} />
      <Stack.Screen name='vismotriDasha' component={VismotriDasha} options={{ headerShown: false }} />
      <Stack.Screen name='devisonChart' component={DevisionChart} options={{ headerShown: false }} />
      ...
      <Stack.Screen name='panch' component={Panchangeclick} options={{ headerShown: false }} />
      <Stack.Screen name='panchdata' component={PanchangeData} options={{ headerShown: false }} />
      <Stack.Screen name='pachhome' component={PanchHome} options={{ headerShown: false }} />
      <Stack.Screen name='muhurat' component={Muhurat} options={{ headerShown: false }} />
      <Stack.Screen name='durmuhurat' component={DurMuhurat} options={{ headerShown: false }} />
      <Stack.Screen name='yogdata' component={Yogdata} options={{ headerShown: false }} />
      <Stack.Screen name='yoghome' component={Yoghome} options={{ headerShown: false }} />
      <Stack.Screen name='openpanch' component={Pnachang} options={{ headerShown: false }} />
      <Stack.Screen name="Address" component={Address} options={{ headerShown: false }} />
      <Stack.Screen name="Addaddress" component={AddAddress} options={{ headerShown: false }}/>
      <Stack.Screen name="supportuser" component={Supportuser} options={{ headerShown: false }}/>
    </Stack.Navigator>
  );
};
